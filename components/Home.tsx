                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 z-10 text-center lg:text-left">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-8 space-y-8">
                            ...
                            >
                                <p className="text-xs font-semibold tracking-widest uppercase text-zinc-500 mb-4">Trusted By Elite Partners</p>
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto lg:mx-0">
                                    {trustBadges.map((badge) => (
                                        <div key={badge} className="flex items-center gap-2 text-zinc-400 text-sm justify-center lg:justify-start">
                                            <CheckCircle2 size={16} className="text-white shrink-0" />
                                            <span className="font-medium text-xs sm:text-sm">{badge}</span>
                                        </div>
                                    ))}
                                </div>
                            </motion.div>
